...
namespace Unity.Samples.ScreenReader
{
    ...
    public class VisualTreeAccessibilityUpdater
    {
        ...
        UITkAccessibilityManager m_AccessibilityManager;

        /// <summary>
        /// The hierarchy this updater is managing.
        /// </summary>
        public AccessibilityHierarchy hierarchy => AccessibilityManager.hierarchy;
        ...
        public VisualTreeAccessibilityUpdater(IPanel panel, VisualElement visualTree, UITkAccessibilityManager manager)
        {
            this.panel = panel;
        ...
        public VisualElementAccessibilityHandler GetHandlerForVisualElement(VisualElement element)
        {
        ...
        public void CleanUp()
        {
            foreach (var handler in m_HandlersForElements)
            {
        ...
        public bool OnVersionChangedInternal(VisualElement ve, VersionChangeType versionChangeType)
        {
            ...
            /*if ((versionChangeType & (VersionChangeType.DisableRendering | VersionChangeType.Layout | VersionChangeType.Transform)) != 0)
            {
                ...
                {
                    OnVersionChangedInternal(child, versionChangeType);
                }
            }*/
