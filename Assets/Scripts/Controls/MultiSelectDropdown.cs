...
namespace Unity.Samples.Controls
{
    ...
    public class MultiSelectDropdown : Selectable, IPointerClickHandler, ISubmitHandler, ICancelHandler
    {
        ...
        [Space] [SerializeField] private TMP_Text m_ItemText;
        ...
        [Space] [SerializeField] private List<int> m_Values = new ();
        ...
        private TweenRunner<FloatTween> GetOrCreateAlphaTweenRunner()
        {
        ...
        public int value
        {
            get { return m_Values.Count > 0 ? m_Values[0] : -1; }
            set { SetValue(value); }
        }
        ...
        public void RefreshShownValue()
        {
            ...
            {
                if (dataList.Count > 0)
                    m_CaptionImage.sprite = dataList[0].image;
                else
        ...
        public void Show()
        {
            ...
            for (int i = 0; i < options.Count; ++i)
            {
                ...
                DropdownItem item = AddItem(data, values.Contains(i), itemTemplate, m_Items);
                if (item == null)
                    continue;
