...
namespace Unity.Samples.ScreenReader
{
    ...
    public class AccessibleElement : MonoBehaviour
    {
        ...
        /// <summary>
        /// The accessibility label (name) for the element.
        /// If not set, defaults to the element's text content.
        /// </summary>
        public string label
        {
            get => m_Label;
        ...
        /// <summary>
        /// The accessibility value for the element.
        /// </summary>
        public string value
        {
            get => m_Value;
        ...
        /// <summary>
        /// The accessibility hint for the element.
        /// </summary>
        public string hint
        {
            get => m_Hint;
        ...
        /// <summary>
        /// The accessibility role for the element.
        /// </summary>
        ...
        /// <summary>
        /// The accessibility state for the element.
        /// </summary>
        ...
        /// <summary>
        /// Whether the element is active for accessibility.
        /// </summary>
        public bool isActive
        {
            ...
            set
            {
                ...
                if (node != null)
                {
                    node.isActive = value && gameObject.activeInHierarchy;
                }
            }
        }
        ...
        /// <summary>
        /// Whether the element allows direct interaction.
        /// </summary>
        ...
        Func<AccessibilityScrollDirection, bool> m_Scrolled;
        ...
        void Awake()
        {
            frameGetter = () => AccessibilityManager.GetFrame(gameObject.transform as RectTransform);
        }
        ...
        void UnregisterNodeCallbacks()
        {
            UnregisterFocused();
            UnregisterSelected();
            UnregisterIncremented();
            UnregisterDecremented();
            UnregisterScrolled();
            UnregisterDismissed();
        }
        ...
        void RegisterFocused()
        {
            ...
            node.focusChanged -= InvokeFocusChanged;
            node.focusChanged += InvokeFocusChanged;
        }
        ...
        void InvokeFocusChanged(AccessibilityNode accessibilityNode, bool isFocused)
        {
        ...
        void RegisterSelected()
        {
            ...
            // a specific behavior. Therefore, we don't implement the node's selected event unless we actually need it.
        ...
        void RegisterDismissed()
        {
            // Implementing the dismissed event tells the screen reader that the node is dismissible, which may lead to
            // a specific behavior. Therefore, we don't implement the node's dismissed event unless we actually need it.
            ...
            switch (direction)
            {
                case AccessibilityScrollDirection.Forward:
                {
                    while (siblingIndex < siblings.Count - 1)
                    {
                        ...
                        var siblingElement = AccessibilityManager.GetAccessibleElementForNode(sibling);
